      ...
      <div className="min-h-screen flex justify-center items-center">
        <div className="mx-auto grid grid-cols-1 md:grid-cols-2  mt-10 md:mt-0">
          <div className="min-h-screen sm:min-h-0 flex justify-center items-start flex-col mb-5 space-y-10 mx-auto">
            <div>
              <h2 className="uppercase font-normal text-lg tracking-[8px] text-gray-200">
                Project
              </h2>
            ...
            <div>
              ...
              <p className="text-2xl font-normal text-gray-100">
                {data.tech.join(", ")}
              </p>
            </div>
            <div>
              ...
              <p className="text-2xl font-normal text-gray-100">{data.year}</p>
            </div>
            {data.preview && (
              <div>
                <h2 className="uppercase font-normal text-lg tracking-[8px] text-gray-200">
          ...
          <div className="flex justify-start items-start flex-col mb-5 ">
            ...
            {data.desc.map((desc, index) => (
              <p
                key={index}
                className="text-xl text-justify tracking-wide font-normal text-white mb-5"
              >
                {desc}
              </p>
            ))}
